...
def create_xml(line):
    contents = line.strip().split(' ')
    xml_dir = r'/Users/cpz/Desktop/Google AI Camp/dataset/fashion/Annotations'
    img_dir = r'/Users/cpz/Desktop/Google AI Camp/dataset/fashion/JPEGImages'
    folder_content = r'fashion'
